...
import com.kams.common.utils.CommonUtils;
import com.kams.common.utils.DateFormatUtils;
import com.kams.dao.SmFunMapper;
import com.kams.dao.SmUserjfMapper;
import com.kams.dao.SmUserjfmxMapper;
...
public class FunService {
		...
		if (list.size() > 0) {
			for (SmFun sm : list) {
				if (!sm.getFval8().equals("sys")) {
					...
					System.out.println("开奖是：" + smFun.getFval1() + "," + smFun.getFval2() + "," + smFun.getFval3() + ","
							+ smFun.getFval9() + " == 投注是：" + sm.getFval1() + "," + sm.getFval2() + "," + sm.getFval3()
							+ "," + sm.getFval9() + "=====" + string);
				}
			}
		}
		...
		if (list.size() > 0) {
			for (SmFun sm : list) {
				if (!sm.getFval8().equals("sys")) {
					...
					System.out.println("开奖是：" + smFun.getFval1() + "," + smFun.getFval2() + "," + smFun.getFval3() + ","
							+ smFun.getFval4() + "," + smFun.getFval5() + "," + smFun.getFval6() + ","
							+ smFun.getFval7() + " == 投注是：" + sm.getFval1() + "," + sm.getFval2() + "," + sm.getFval3()
							+ "," + sm.getFval4() + "," + sm.getFval5() + "," + sm.getFval6() + "," + sm.getFval7()
							+ "=====" + string);
				}
			}
		}
	...
	private String sortpDLT(SmFun jiang, SmFun tou) {
		...
		System.out.println("当前开奖是：" + jiang1[0] + "," + jiang1[1] + "," + jiang1[2] + "," + jiang1[3] + "," + jiang1[4]
				+ "====" + jiang2[0] + "," + jiang2[1]);
		System.out.println("当投注是：" + tou1[0] + "," + tou1[1] + "," + tou1[2] + "," + tou1[3] + "," + tou1[4] + "===="
				+ tou2[0] + "," + tou2[1]);
		...
		if ((zhipre == 1 && zhipost == 2) || (zhipre == 2 && zhipost == 1) || (zhipre == 3 && zhipost == 0)
				|| (zhipre == 0 && zhipost == 2)) {// 1+2 / 2+1 / 3+0 / 0+2
	...
	public List<SmFun> shengyaToSys(SmFun smFun) {

		return smFunMapper.shengyaToSys(smFun);
	}
}
